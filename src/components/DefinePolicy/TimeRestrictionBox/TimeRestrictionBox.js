...
import './TimeRestrictionBox.css';
import SelectTimeBox from "../SelectTimeBox/SelectTimeBox";

class TimeRestrictionBox extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            fromTime: null,
        ...
        return(
            <div className="timeSelection">
                <div className="timeSelectBox">
                    ...
                    <div id="timeSelect">
                        <SelectTimeBox options={timestamps} hidden={false} placeholder={'Any'}
...
export default TimeRestrictionBox;